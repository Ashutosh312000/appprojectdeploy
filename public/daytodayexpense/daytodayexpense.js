...
window.addEventListener("DOMContentLoaded", () => { 
    ...
    axios.get('http://18.222.11.116:3000/expense/getexpense',{headers:{"Authorization" : token}})
        .then((response) => {
    ...
    axios.get('http://18.222.11.116:3000/files/downloadfiles',{headers:{"Authorization" : token}})
        .then((response) => {
...
downloadbtn.onclick= async function(e){  
    ...
    const response=await axios.get('http://18.222.11.116:3000/expense/download', {headers:{"Authorization" : token}});
